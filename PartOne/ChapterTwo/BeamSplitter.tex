...
\begin{figure}[htbp]
    ...
    \begin{subfigure}{.45\columnwidth}
        \centering
        \includegraphics[width=.8\columnwidth]{PartOne/ChapterTwo/figures/bs_classical.png}
        \caption{Classical description}
    \end{subfigure}
    \hfill
    \begin{subfigure}{.45\columnwidth}
        \centering
        \includegraphics[width=.8\columnwidth]{PartOne/ChapterTwo/figures/bs_quantum.png}
...
\begin{example}{Mach-Zehnder}
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=.3\columnwidth]{PartOne/ChapterTwo/figures/example_machzenhder.png}
    \end{figure}
    \begin{enumerate}[itemsep=0pt,topsep=0pt,parsep=0pt,label=\alph*)]
        ...
        \item If $\hb_1\to\hb_1e^{i\phi}$, determine the output mode operators at the detector positions $\hc_1=\frac{1}{\sqrt{2}}(\hb_1e^{i\phi}+\hb_2)$ 

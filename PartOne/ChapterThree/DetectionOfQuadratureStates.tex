...
\begin{align*}
    \braket{\hat{I}_{k}}=\braket{\hA^\dagger_{k}\hA_{k}}.
\end{align*}
\begin{figure}[htbp]
    \centering
...
\end{align}
The averaging is about these two states.
\end{comment}
We see that the irradiance is just the average of the number operator counting photons at each output. In particular, we can change the nature of $\alpha_2$ 
to have different quadratures:
\begin{align*}

...
\begin{definition}[Review of Bohr model]
    ...
    \begin{align*}
        \lambda=\frac{2\pi\hbar c}{E}=\frac{2\pi\hbar x}{m_ev^2}.
    \end{align*}
    \begin{align*}
...
\begin{align*}
    V_e&=-\int\;d\bs\cdot\sum_nq_n\delta(\bs-\br_n)\bE(\br_S+\bs)\\
    &=-\sum_nq_n\underbrace{\Phi(\br_A+\br_n)}_{\text{scalar potential}}\\

...
\end{align}
where $\hsigma$ operators are Pauli matrices and corresponds to atomic raising and lowering operators, respectively.

The free Hamiltonian of the atom $\hH_0$ can be expressed in terms of its energy eigenstates:
\begin{align*}
    \hH_0=\sum_nE_n\ket{n}\bra{n}=E_g\ket{g}\bra{g}+E_e\ket{e}\bra{e}=\hbar\omega_0\ket{e}\bra{e}\quad(E_g=0\land E_e=\hbar\omega_0)=\hbar\omega_0\hsigma_+\hsigma_-.
\end{align*}
...
\begin{align}
    ...
    \hH_F&=\sum_{\bk,\lambda}\hbar\omega_{\bk}\left(\ha^\dagger_{\bk,\lambda}\ha_{\bk,\lambda}+\frac{1}{2}\right),\quad[\ha_{\bk,\lambda},\ha^\dagger_{\bk,\lambda}]=1,\\
...
excited state and $\ha_{\bk,\lambda}$ annihilates a photon. Similarly, the second term represents the fundamental process of emission of a single photon 

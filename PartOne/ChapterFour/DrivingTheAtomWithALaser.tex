...
\begin{align*}
    \ket{\Psi(t)}=c_+\ket{+}+c_-\ket{-},\quad c_\pm(t)=c_\pm(0)e^{-iE_\pm t/\hbar},\quad E_\pm=\pm\frac{\hbar}{2}\sqrt{\Delta_L^2+\Omega^2}.
\end{align*}
...
For a detuned laser the atom does not get fully excited. To see this qualitative dynamics we look at the effective Hamiltonian:
\begin{align}
    H_{eff}=\begin{bmatrix}
        -\Delta_L/2&\Omega/2\\\Omega^*/2&\Delta_L/2
    \end{bmatrix}=-\frac{\Delta_L}{2}\hsigma_z+\frac{\re{\Omega}}{2}\hsigma_x-\frac{\im{\Omega}}{2}\hsigma_y.
\end{align}
Let us depict this Hamiltonian and the initial state on the Bloch sphere.
\begin{figure}[htbp]
    \centering
    \begin{subfigure}{.45\columnwidth}
        \centering
        \includegraphics[width=.8\columnwidth]{PartOne/ChapterFour/figures/blochsphere_effhamiltonian_1.png}
    \end{subfigure}
    \hfill
    \begin{subfigure}{.45\columnwidth}
        \centering
        \includegraphics[width=\columnwidth]{PartOne/ChapterFour/figures/blochsphere_effhamiltonian_2.png}
    \end{subfigure}
\end{figure}

...
\begin{align}
    ...
    \end{array},\quad[\hX_1,\hX_2]=\frac{i}{2}},
    \label{eq:quadratureoperator_timeindependent}
\end{align}
In the E-field, if we collect the cosine and sine, we get
\begin{align*}
...
\end{align*}
That is, there is a minimum uncertainty that a state can possible have in the two quadrature $\hX_1,\hX_2$, such a state is refferred as 
...
Coherent states are also referred to as displaced vaccum states:
\begin{align*}
...
The phase space representation of states allows one to access information aabout the noise/variance associated with any state when a specific 

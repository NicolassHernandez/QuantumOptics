...
\begin{enumerate}[itemsep=0pt,topsep=0pt,parsep=0pt,label=\alph*)]
  ...
  The diagram is shown below. Two distances are shown in red to verify that the uncertainty is maintained.
  \begin{figure}[htbp]
    \centering
    \begin{tikzpicture}[scale=.8]
      ...
      \begin{scope}[xshift=5cm]
        ...
        \draw[|-|,very thick,BrickRed](2,{2*sin(45-deg(2))-.3})--(2,{2*sin(45-deg(2))+.3});
        \draw[|-|,very thick,BrickRed](4,{2*sin(45-deg(4))-.3})--(4,{2*sin(45-deg(4))+.3});
      \end{scope}
    \end{tikzpicture}
    \caption{Phase space of a coherent state. Distance in red is shown to verify the uncertainty is maintained.}
  \end{figure}
  ...
  \begin{align*}
    \braket{\hX_2^2(t)}&=-\frac{1}{4}\left\{[\alpha^2-\frac{1}{2}e^{i\phi}\sinh(2r)]e^{-i2\omega t}+[\alpha^{*2}-\frac{1}{2}e^{-i\phi}\sinh(2r)]e^{i2\omega t}-
    \cosh^2(r)-|\alpha|^2-\sinh^2(r)-|\alpha|^2\right\}\\
